    ...
    <div className="max-w-6xl mx-auto px-6">
      <div className="text-center mb-12">
        ...
        <p className="text-slate-600 max-w-2xl mx-auto">
          One platform designed for both sides of the workforce — fair wages for
          workers and reliable hiring for employers.
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl border border-emerald-100 shadow-sm p-8 flex flex-col justify-between">
          ...
          <button className="mt-8 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white font-semibold px-6 py-2.5 shadow-md hover:shadow-lg transition">
            Register as Worker
        ...
        <div className="bg-white rounded-3xl border border-amber-100 shadow-sm p-8 flex flex-col justify-between">
          <div>
            ...
            <p className="text-slate-600 mb-5">
              Hire verified, skilled workers quickly and efficiently with full
              transparency and rating-based profiles.
            </p>
          ...
          <button className="mt-8 inline-flex items-center justify-center rounded-full bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold px-6 py-2.5 shadow-md hover:shadow-lg transition">
